...
export default function CatalogoPage() {
  ...
  // Por ahora muestra feedback — se conectará con el carrito en CU20
  const handleAgregarCarrito = (producto: CatalogoProducto) => {
    showFeedback(`"${producto.nombre}" agregado al carrito`, 'success')
    // TODO: conectar con useCarrito del CU20
  }
