import { LayoutList, AlignLeft, GitBranch, BarChart2 } from 'lucide-react'
    ...
    <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap items-center gap-3 justify-center sm:justify-start">
            <span className={`inline-flex items-center gap-1.5 rounded-lg px-3 py-1 text-[10px] font-black uppercase tracking-widest ${
              ...
              <div className={`h-1.5 w-1.5 rounded-full ${categoria.activo ? 'bg-emerald-500 animate-pulse' : 'bg-rose-500'}`} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <InfoCard
          ...
          value={categoria.nombreCategoriaPadre || 'Ninguna (categoría raíz)'}
        />
        <InfoCard
          icon={<BarChart2 size={20} />}
          label="Nivel en la jerarquía"
          value={`Nivel ${categoria.nivel}`}
        />
      </div>
    </div>
  )
