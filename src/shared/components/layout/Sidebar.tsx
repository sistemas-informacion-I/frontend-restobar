...
import { Users, Shield, LayoutDashboard, Activity, User, Store, Map, Grid, Truck, Package, LayoutList, ShoppingCart, ShoppingBag, ChefHat, Utensils, BookOpen, CreditCard, ClipboardList, CookingPot, DollarSign, FileBarChart, CalendarDays, CalendarCheck, Bike, BarChart3 } from 'lucide-react'
  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/ventas', label: 'Ventas', icon: DollarSign, show: user?.tipoUsuario === 'S' || user?.tipoUsuario === 'E' || user?.tipoUsuario === 'C' },
